...
import { IOwner, IInspector, IMessenger, IOFT, IRateLimiter, RateLimitConfig } from "./interfaces/IOndoOwner.sol";

/**
 * @title Owner
 * @notice Central administrative contract that manages access control and ownership
 * for the Test bridge system components.
 * @dev Implements role-based access control using OpenZeppelin's AccessControlEnumerable
 */
contract Owner is IOwner, AccessControlEnumerable {
    /**
    ...
    /**
     * @notice Constructs the Owner contract with initial administrators
     ...
     * @return oftAddress The address of the newly created OFT contract
    ...
    /**
     * @notice Sets the Messenger address for an OFT contract
     * @param _oft The OFT contract instance
     * @param _messenger The address of the Messenger contract
     * @dev This function can only be called by accounts with the DEFAULT_ADMIN_ROLE
     */
    function setMessengerOFT(IOFT _oft, address _messenger) external only(DEFAULT_ADMIN_ROLE) {

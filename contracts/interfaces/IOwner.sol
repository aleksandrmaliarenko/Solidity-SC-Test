...
/**
 * @title IOwner
 * @notice Interface for the Owner contract, which manages administrative access control
 * and ownership of various components in the test bridge system.
 */
interface IOwner {
     ...
     * @param oft The OFT contract instance.
     * @param messenger The address of the Messenger contract.
     */
    function setMessengerOFT(IOFT oft, address messenger) external;
